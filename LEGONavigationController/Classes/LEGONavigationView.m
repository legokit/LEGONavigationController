...
@end
@implementation LEGONavigationView
...
@implementation LEGONavigationButton

+ (instancetype)buttonWithTitle:(NSString *)title image:(UIImage *)image {
    LEGONavigationButton *button  = [LEGONavigationButton buttonWithType:UIButtonTypeCustom];
