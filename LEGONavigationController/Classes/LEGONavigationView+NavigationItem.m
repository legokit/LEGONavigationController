//
//  LEGONavigationView+NavigationItem.m
//  FilmCamera
//
...
@interface LEGONavigationView ()
@property (nonatomic, strong) NSMutableDictionary *callbackDic;
@end

@implementation LEGONavigationView (NavigationItem)
...
- (LEGONavigationButton *)createButtonWithTitle:(NSString *)title
                                        image:(UIImage *)image
                                    placeType:(NavigationItemPlaceType)placeType
                                     callback:(itemCallback)callback {
    LEGONavigationButton *button = [LEGONavigationButton buttonWithTitle:title image:image];
...
- (void)buttonClick:(LEGONavigationButton *)sender {
