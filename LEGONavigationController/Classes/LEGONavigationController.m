...
- (void)statusBarChangeNoti:(NSNotification *)notifycation {
    ...
    LEGONavigationView *navigationView = (LEGONavigationView *)self.topViewController.navigationView;
    ...
    if (device.orientation == UIDeviceOrientationPortrait || device.orientation == UIDeviceOrientationPortraitUpsideDown) {
        if (navigationView.leftButton && IS_IPHONE_X) {
            LEGONavigationButton *leftButton = navigationView.leftButton;
        ...
        if (navigationView.rightButton && IS_IPHONE_X) {
            LEGONavigationButton *rightButton = navigationView.rightButton;
